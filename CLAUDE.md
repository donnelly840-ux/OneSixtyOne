...
- Rule for future effects: on touch devices, **anything that moves across the screen while the page scrolls must be time-based, not scroll-linked.** Motion over a pinned background is OK.
